...
/**
 * Created by liutf on 2016/09/13 21:29.
 */
public class MyHttpUtil {
     ...
     * @param  needContent  是否需要内容,判断返回状态码
     * @return 与当前请求对应的响应内容字节数组
     *
     */
    public static byte[] doPost(String url , Map parameterMap,boolean needContent) {
        return doPost(url , null , parameterMap , null , null , 0,needContent);
    }
     ...
     */
    public static byte[] doPost(String url , Map headerMap , Map parameterMap , String paramCharset , String proxyUrl , int proxyPort,boolean needContent) {
        byte[]     content    = null;
